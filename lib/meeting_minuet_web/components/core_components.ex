defmodule MeetingMinuetWeb.CoreComponents do
  @moduledoc """
  ...
  """
  attr :class, :string, default: nil
  attr :text_class, :string, default: "text-lg font-semibold leading-8 text-zinc-800"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MeetingMinuetWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MeetingMinuetWeb.Gettext, "errors", msg, opts)
    end
  end
