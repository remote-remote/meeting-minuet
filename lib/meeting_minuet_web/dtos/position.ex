defmodule MeetingMinuetWeb.DTO.Position do
  alias __MODULE__
  alias MeetingMinuetWeb.DTO.PositionTenure
  ...
  def map(%MeetingMinuet.Organizations.Position{} = p) do
  ...
  def map_list([%MeetingMinuet.Organizations.Position{} | _] = positions) do
  ...
  def unmap(%Position{} = p) do
    %MeetingMinuet.Organizations.Position{
      id: p.id,
      organization_id: p.organization_id,
      name: p.name,
      description: p.description,
...
defmodule MeetingMinuetWeb.DTO.PositionTenure do
  alias __MODULE__
  alias MeetingMinuet.Organizations.Tenure
