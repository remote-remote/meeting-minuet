defmodule MeetingMinuet.PresenceHelper do
  defmacro __using__(opts) do
    quote do
      use Phoenix.Presence,
        otp_app: unquote(opts[:otp_app]) || :meeting_minuet,
        pubsub_server: unquote(opts[:pubsub_server]) || MeetingMinuet.PubSub
      ...
      def subscribe(id) when is_integer(id) or is_binary(id) do
        Phoenix.PubSub.subscribe(MeetingMinuet.PubSub, topic(id))
      end
