defmodule MeetingMinuet.Organizations.Position do
  use Ecto.Schema
  import Ecto.{Changeset, Query}
  alias MeetingMinuet.Organizations.{Membership, Tenure, Organization}
  ...
  def q_list_with_tenures(org_id) do
    from p in MeetingMinuet.Organizations.Position,
